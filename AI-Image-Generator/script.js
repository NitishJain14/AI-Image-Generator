...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () => 
      `<div class="img-card loading">
        <img src="load.svg" alt="AI generated image">
        <a class="download-btn" href="#">
          <img src="down.jpg" alt="download icon">
        </a>
      </div>`
  ).join("");
